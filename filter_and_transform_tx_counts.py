...
def main(argv):
    ...
    parser.add_argument('-o', '--output_dir', metavar='/path_to_output_dir/', type=str, default = def_dir, help = "Output directory path where the SPIT output folder will be written")
