...
def main(argv):
    ...
    parser.add_argument('--ctrl', metavar='ctrl_samples.txt', required=True, type=str, help='Output file path for simulated ctrl ids')
    parser.add_argument('--case', metavar='case_samples.txt', required=True, type=str, help='Output file path for simulated case ids')
